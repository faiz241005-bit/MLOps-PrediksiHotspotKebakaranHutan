...
> Status: 🚧 Under construction (LK01–LK08)
...
| LK02 | Repo + Codespaces + GitHub Flow | ✅ Done (dokumen ini) |
| LK03 | EDA awal + DVC setup | ⏳ Pending |
| LK04 | Pipeline ingestion + preprocessing | ⏳ Pending |
| LK05 | Training pipeline + MLflow tracking | ⏳ Pending |
| LK06 | CI/CD GitHub Actions | ⏳ Pending |
| LK07 | Monitoring + drift detection | ⏳ Pending |
| LK08 | FastAPI serving + dokumentasi final | ⏳ Pending |
